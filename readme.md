# Spring PetClinic Sample Application [![Build Status](https://travis-ci.org/spring-projects/spring-petclinic.png?branch=master)]([![Java CI with Maven](https://github.com/dachmad/spring-petclinic/actions/workflows/maven.yml/badge.svg)](https://github.com/dachmad/spring-petclinic/actions/workflows/maven.yml))
